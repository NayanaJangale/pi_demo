...
import 'package:pulse_india/components/tree_components/CustomExpansionTile.dart';
import 'package:pulse_india/components/tree_components/CustomListTile.dart';
import 'package:pulse_india/components/tree_components/Global.dart';
...
class TreeNodeState extends State<TreeNode> {
  ...
  void selectNodes(TreeNodeData currentNode, bool value) {
    ...
    if (!value) {
      ...
      TreeNodeData parent = currentNode.getRoot();
      parent.checked = value;
      //selectNodes(currentNode.getRoot(), value);
      // }
    }
  }
  ...
  Widget buildExpandedNode(TreeNodeData currentNode) {
    _wExpand = new CustomExpansionTile(
      ...
      children: [
        new Container(
          padding: new EdgeInsets.only(left: Constants.LIST_ITEM_INDENT * 1.5),
          child: new Column(
