...
class CustomFancyButton extends StatefulWidget {
  ...
  @override
  _CustomFancyButtonState createState() => _CustomFancyButtonState();
}

class _CustomFancyButtonState extends State<CustomFancyButton>
  ...
  void _setupAnimation() {
    double buttonDepth = widget.size * 0.1;
  ...
  @override
  void didUpdateWidget(CustomFancyButton oldWidget) {
